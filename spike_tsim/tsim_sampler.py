...
This is the deliverable of the spike_tsim half-day investigation. It
demonstrates that sinter's Sampler ABC is clean enough to drop in an
alternative simulator with no sinter fork, no upstream patches, and
no monkey-patching.
